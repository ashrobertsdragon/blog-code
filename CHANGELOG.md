...
- **Backend**: Implemented Passenger WSGI entry point in `passenger_wsgi.py`
  ...
  - Added sys.path configuration for proper module imports (application root and src/ directory)
